...
export default function TeamLobbyPage() {
  ...
  const removeMember = useTeamStore((state) => state.removeMember); // 追加: 削除関数
    ...
    <main className="min-h-screen bg-white flex flex-col items-center p-6">
      ...
      <div className="mb-6 w-full max-w-xs flex flex-col gap-3">
        {members.map((member, index) => (
          <div
            key={index}
            className={`${member.color || 'bg-gray-200'} text-gray-800 rounded-lg px-4 py-2 font-semibold flex justify-between items-center`}
          >
